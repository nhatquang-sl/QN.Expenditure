...
namespace Application.UnitTests.Auth.Commands.Register
{
    public class ValidatePasswordTests : DependencyInjectionFixture
    {
        ...
        public async Task FailsIfTooShortTests(string input)
        {
            ...
            // Assert
            exception.Message.ShouldBe(@"{""message"":{""password"":""Password must be at least 6 characters.""}}");
        }
        ...
        public async Task FailsIfMissingUpper(string input)
        {
            ...
            // Assert
            exception.Message.ShouldBe(@"{""message"":{""password"":""Password must have at least one uppercase (\u0027A\u0027-\u0027Z\u0027).""}}");
        }
        ...
        public async Task FailsIfMissingNumber(string input)
        {
            ...
            // Assert
            exception.Message.ShouldBe(@"{""message"":{""password"":""Password must contain at least one number.""}}");
        }
