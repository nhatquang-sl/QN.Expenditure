...
namespace Cex.Infrastructure.Migrations
{
    ...
    [Migration("20260113095152_IX_TradeHistories_Stats")]
    partial class IX_TradeHistories_Stats
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Cex.Domain.Entities.TradeHistory", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2026, 1, 13, 9, 51, 51, 366, DateTimeKind.Utc).AddTicks(530));
