...
namespace Cex.Infrastructure.Migrations
{
    ...
    [Migration("20251205142055_ExchangeSetting")]
    partial class ExchangeSetting
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Cex.Domain.Entities.TradeHistory", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 12, 5, 14, 20, 54, 769, DateTimeKind.Utc).AddTicks(1870));
