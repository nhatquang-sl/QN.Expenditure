...
export default function TabSummary(props: {
  ...
  useEffect(() => {
    if (lowerPrice && upperPrice && numberOfGrids && upperPrice - lowerPrice >= 0) {
      ...
      setDetails(gridDetails);
      dispatch(setGridDetails(gridDetails));
    }
  }, [lowerPrice, upperPrice, numberOfGrids, investment, dispatch]);
  ...
  return (
    <>
      <Grid container spacing={0}>
        ...
        <Grid item xs={6} md={10}>
          <Typography variant="subtitle2">{investment / numberOfGrids}</Typography>
        </Grid>
      </Grid>
