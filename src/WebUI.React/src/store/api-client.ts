...
export class AuthClient {
    ...
    refresh( cancelToken?: CancelToken): Promise<UserAuthDto> {
    ...
    protected processRefresh(response: AxiosResponse): Promise<UserAuthDto> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (const k in response.headers) {
...
export class BnbSpotClient {
    ...
    getSpotOrdersBySymbol(symbol: string, cancelToken?: CancelToken): Promise<SpotOrderRaw[]> {
        let url_ = this.baseUrl + "/api/bnbspot/{symbol}";
        if (symbol === undefined || symbol === null)
            throw new globalThis.Error("The parameter 'symbol' must be defined.");
        url_ = url_.replace("{symbol}", encodeURIComponent("" + symbol));
        url_ = url_.replace(/[?&]$/, "");
...
export class CandlesClient {
    ...
    get(symbol: string, interval: IntervalType, cancelToken?: CancelToken): Promise<Kline[]> {
        ...
        if (interval === undefined || interval === null)
            throw new globalThis.Error("The parameter 'interval' must be defined.");
...
export class ExchangeSettingsClient {
    ...
    deleteSetting(exchangeName: ExchangeName, cancelToken?: CancelToken): Promise<FileResponse> {
        ...
        if (exchangeName === undefined || exchangeName === null)
            throw new globalThis.Error("The parameter 'exchangeName' must be defined.");
...
export class HybridCacheClient {
    ...
    get(key: string, cancelToken?: CancelToken): Promise<string> {
    ...
    deleteByTags(tags: string, cancelToken?: CancelToken): Promise<FileResponse> {
        ...
        url_ = url_.replace("{tags}", encodeURIComponent("" + tags));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.instance.request(options_).catch((_error: any) => {
            ...
            return this.processDeleteByTags(_response);
        });
    }
...
export class SpotGridClient {
    ...
    get(spotGridId: number, cancelToken?: CancelToken): Promise<SpotGridDto> {
        ...
        if (spotGridId === undefined || spotGridId === null)
            throw new globalThis.Error("The parameter 'spotGridId' must be defined.");
...
export class Kline {
    ...
    init(_data?: any) {
        if (_data) {
            this.openTime = _data["openTime"] ? new Date(_data["openTime"].toString()) : undefined as any;
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["openTime"] = this.openTime ? this.openTime.toISOString() : undefined as any;
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.gridSteps)) {
            ...
            for (let item of this.gridSteps)
                data["gridSteps"].push(item ? item.toJSON() : undefined as any);
        }
        return data;
    }
}
...
export class TradeHistoryDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.tradedAt = _data["tradedAt"] ? new Date(_data["tradedAt"].toString()) : undefined as any;
    ...
    toJSON(data?: any) {
        ...
        data["tradedAt"] = this.tradedAt ? this.tradedAt.toISOString() : undefined as any;
...
export class TradeStatisticsDto {
    ...
    init(_data?: any) {
        if (_data) {
            this.buy = _data["buy"] ? SideStatisticsDto.fromJS(_data["buy"]) : undefined as any;
            this.sell = _data["sell"] ? SideStatisticsDto.fromJS(_data["sell"]) : undefined as any;
        }
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["buy"] = this.buy ? this.buy.toJSON() : undefined as any;
        data["sell"] = this.sell ? this.sell.toJSON() : undefined as any;
        return data;
    }
}
