...
namespace Lib.ExternalServices.Telegram.Models
{
    public class TelegramMessage
    {
        ...
        [JsonPropertyName("parse_mode")] public string ParseMode => "HTML";
    }

    public class TelegramTopicMessage(string chatId, string messageThreadId, string text)
        : TelegramMessage(chatId, text)
    {
        [JsonPropertyName("message_thread_id")]
        public string MessageThreadId { get; set; } = messageThreadId;
    }
    ...
    public class TelegramMessageResponse
    {
        ...
        [JsonPropertyName("result")] public TelegramMessageResult Result { get; set; }
    }
    ...
    public class TelegramMessageResult
    {
        ...
        [JsonPropertyName("sender_chat")] public TelegramMessageChat SenderChat { get; set; }

        [JsonPropertyName("chat")] public TelegramMessageChat Chat { get; set; }
