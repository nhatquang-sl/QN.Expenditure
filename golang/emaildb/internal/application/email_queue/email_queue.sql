...
INSERT INTO "EmailQueue" ("EmailTypeId", "HtmlData", "UserId", "ToEmail")
VALUES ($1, $2, $3, $4)
RETURNING "Id", "EmailTypeId", "HtmlData", "Status", "Retry", "NextRetryAt", "UserId", "ToEmail", "CreatedAt", "UpdatedAt";
